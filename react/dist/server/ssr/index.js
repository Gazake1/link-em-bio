...
function isHashOnlyChange(href) {
	...
	try {
		...
		return stripBasePath(current.pathname, "/saiba-mais") === stripBasePath(next.pathname, "/saiba-mais") && current.search === next.search && next.hash !== "";
	} catch {
		return false;
	}
}
...
var client_references_default = {
	"2e86ca7e1157": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-w__6aOY0.js")).export_2e86ca7e1157;
	},
	"19cc3f2900f4": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-w__6aOY0.js")).export_19cc3f2900f4;
	},
	"05e358f6455c": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-w__6aOY0.js")).export_05e358f6455c;
	},
	"a8476ac92304": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-w__6aOY0.js")).export_a8476ac92304;
	},
	"593f344dc510": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-w__6aOY0.js")).export_593f344dc510;
	},
	"15c18cfaeeff": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-w__6aOY0.js")).export_15c18cfaeeff;
	},
	"c2747888630f": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-w__6aOY0.js")).export_c2747888630f;
	}
};
//#endregion
...
//#endregion
export { toRscUrl as a, app_ssr_entry_default as default, handleSsr, prefetchRscResponse as i, getPrefetchedUrls as n, usePathname as o, navigateClientSide as r, getLayoutSegmentContext as t };

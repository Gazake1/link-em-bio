...
import { a as toRscUrl, i as prefetchRscResponse, n as getPrefetchedUrls, o as usePathname, r as navigateClientSide, t as getLayoutSegmentContext } from "../index.js";
...
//#endregion
//#region components/shared/theme-provider.tsx
...
function useRefWithInit(init, initArg) {
	const ref = t.useRef(UNINITIALIZED);
...
var FloatingDelayGroupContext = /* @__PURE__ */ t.createContext({
	hasProvider: false,
	timeoutMs: 0,
	delayRef: { current: 0 },
...
function FloatingDelayGroup(props) {
	...
	const delayRef = t.useRef(delay);
	const initialDelayRef = t.useRef(delay);
	const currentIdRef = t.useRef(null);
	const currentContextRef = t.useRef(null);
...
var majorVersion = parseInt(t.version, 10);
...
function getReactElementRef(element) {
	if (!/* @__PURE__ */ t.isValidElement(element)) return null;
...
function evaluateRenderProp(element, render, props, state) {
	if (render) {
		...
		if (newElement?.$$typeof === REACT_LAZY_TYPE) newElement = t.Children.toArray(render)[0];
		return /* @__PURE__ */ t.cloneElement(newElement, mergedProps);
	}
	if (element) {
...
function renderTag(Tag, props) {
	...
	return /* @__PURE__ */ t.createElement(Tag, props);
}
//#endregion
//#region node_modules/@base-ui/react/esm/tooltip/provider/TooltipProviderContext.js
var TooltipProviderContext = /* @__PURE__ */ t.createContext(void 0);
//#endregion
...
function AppProviders({ children }) {
	return /* @__PURE__ */ jsxs(ThemeProvider, { children: [/* @__PURE__ */ jsx(TooltipProvider, { children }), /* @__PURE__ */ jsx(Toaster, {
		position: "top-right",
		richColors: true
	})] });
}
...
*/
var Separator$1 = /* @__PURE__ */ t.forwardRef(function SeparatorComponent(componentProps, forwardedRef) {
...
var Link = forwardRef(function Link({ href, as, replace = false, prefetch: prefetchProp, scroll = true, children, onClick, onNavigate, ...rest }, forwardedRef) {
	...
	const handleClick = async (e) => {
		...
		if (typeof window.__VINEXT_RSC_NAVIGATE__ === "function") {
			...
			const Router = (await import("./router-T90cRp3b.js")).default;
...
var export_2e86ca7e1157 = { AppProviders };
var export_19cc3f2900f4 = { Separator };
var export_05e358f6455c = { useRefWithInit };
var export_a8476ac92304 = { default: Icon };
...
//#endregion
export { export_05e358f6455c, export_15c18cfaeeff, export_19cc3f2900f4, export_2e86ca7e1157, export_593f344dc510, export_a8476ac92304, export_c2747888630f };
